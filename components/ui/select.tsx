...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-2 border-sunshine-brown/20 data-[placeholder]:text-sunshine-brown/60 [&_svg:not([class*='text-'])]:text-sunshine-brown/60 flex w-fit items-center justify-between gap-2 rounded-full bg-sunshine-white text-sunshine-brown px-4 py-3 text-sm whitespace-nowrap outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-11 data-[size=sm]:h-10 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
