    ...
    <div className="bg-sun-cream">
      <section className="px-4 sm:px-6 py-12 md:py-16 overflow-hidden bg-sun-gold text-sun-cocoa">
        <FadeInView className="max-w-5xl mx-auto space-y-4 text-center">
          <p className="font-subhead uppercase tracking-[0.15em] font-bold text-xs text-sun-plum">Community</p>
          <h1 className="font-headline text-[clamp(2.8rem,6vw,4.6rem)] uppercase leading-[0.9] tracking-tight text-sun-plum">
      ...
      <section className="px-4 sm:px-6 py-12 md:py-16 overflow-hidden bg-sun-plum text-white">
        <div className="max-w-6xl mx-auto space-y-8">
          <FadeInView className="space-y-2 text-center">
            <p className="font-subhead uppercase tracking-[0.15em] font-bold text-xs text-sun-gold">Content pillars</p>
            ...
            {pillars.map((pillar) => (
              <StaggerItem key={pillar.title}>
                <BrandCard className="p-7 h-full" variant="white">
                  <h4 className="font-headline text-2xl uppercase text-sun-plum mb-2">{pillar.title}</h4>
            ...
            {connection.map((item) => (
              <StaggerItem key={item.title}>
                <BrandCard className="p-5 h-full" variant="white">
                  <h4 className="font-headline text-xl uppercase text-sun-plum mb-1">{item.title}</h4>
                  <p className="font-body text-sm leading-relaxed text-sun-cocoa">{item.copy}</p>
                </BrandCard>
              </StaggerItem>
            ))}
          </StaggerChildren>
      ...
      <section className="px-4 sm:px-6 py-16 md:py-24 overflow-hidden bg-sun-coral">
        <FadeInView className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <p className="font-body text-lg leading-relaxed text-white/90 max-w-xl mx-auto">
